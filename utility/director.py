...
class Director:
    ...
    def _get_inputs(self, cast):
        """Gets directional input from the keyboard and applies it to the player character.
    ...
    def _do_updates(self, cast):
        ...
        for artifact in artifacts:
            ...
            if player.get_position().equals(artifact.get_position()):
                player.score.add_score(artifact.get_points())
                artifact.respawn()

        banner.set_text(f"Score: {player.score.get_score()}")
